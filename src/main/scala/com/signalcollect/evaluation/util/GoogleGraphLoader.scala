...
//
//class GoogleGraphLoader(numberOfWorkers: Int, edgeFilename: String = "web-Google.txt", directed: Boolean = true) extends GraphProvider[Int, Double] {
//  def populate(graphEditor: GraphEditor[Int, Double], vertexBuilder: (Int) => Vertex[Int, _], edgeBuilder: (Int, Int) => Edge[Int]) {
//    //    //Load the vertices
